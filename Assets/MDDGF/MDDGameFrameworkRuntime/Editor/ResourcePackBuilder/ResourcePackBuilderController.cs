...
namespace MDDGameFramework.Editor.ResourceTools
{
    public sealed class ResourcePackBuilderController
    {
        ...
        {
            m_ConfigurationPath = Type.GetConfigurationPath<ResourceBuilderConfigPathAttribute>() ?? Utility.Path.GetRegularPath(Path.Combine(Application.dataPath, "MDDGameFramework/Configs/ResourceBuilder.xml"));
        ...
        public event MDDGameFrameworkAction<int> OnBuildResourcePacksStarted = null;

        public event MDDGameFrameworkAction<int, int> OnBuildResourcePacksCompleted = null;

        public event MDDGameFrameworkAction<int, int, string, string> OnBuildResourcePackSuccess = null;

        public event MDDGameFrameworkAction<int, int, string, string> OnBuildResourcePackFailure = null;
