...
namespace MDDGameFramework.Editor.ResourceTools
{
    public sealed class SourceFolder
    {
        ...
        public SourceFolder GetFolder(string name)
        {
            ...
            {
                throw new MDDGameFrameworkException("Source folder name is invalid.");
            }
        ...
        public SourceFolder AddFolder(string name)
        {
            ...
            if (folder != null)
            {
                throw new MDDGameFrameworkException("Source folder is already exist.");
            }
        ...
        public SourceAsset GetAsset(string name)
        {
            if (string.IsNullOrEmpty(name))
            {
                throw new MDDGameFrameworkException("Source asset name is invalid.");
            }
        ...
        public SourceAsset AddAsset(string guid, string path, string name)
        {
            ...
            {
                throw new MDDGameFrameworkException("Source asset guid is invalid.");
            }

            if (string.IsNullOrEmpty(path))
            {
                throw new MDDGameFrameworkException("Source asset path is invalid.");
            }
            ...
            if (asset != null)
            {
                throw new MDDGameFrameworkException(Utility.Text.Format("Source asset '{0}' is already exist.", name));
            }
