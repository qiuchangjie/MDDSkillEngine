...
namespace MDDGameFramework.Runtime
{
    ...
    /// 数据表组件。
    /// </summary>
    public sealed class DataTableComponent : MDDGameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_DataTableHelperTypeName = "MDDGameFramework.Runtime.DefaultDataTableHelper";
        ...
        protected override void Awake()
        {
            ...
            m_DataTableManager = MDDGameFrameworkEntry.GetModule<IDataTableManager>();
        ...
        private void Start()
        {
            ...
            {
                m_DataTableManager.SetResourceManager(MDDGameFrameworkEntry.GetModule<IResourceManager>());
            }
