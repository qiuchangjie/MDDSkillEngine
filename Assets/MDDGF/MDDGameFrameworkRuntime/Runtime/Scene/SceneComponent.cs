...
namespace MDDGameFramework.Runtime
{
    ...
    /// 场景组件。
    /// </summary>
    public sealed class SceneComponent : MDDGameFrameworkComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_SceneManager = MDDGameFrameworkEntry.GetModule<ISceneManager>();
            ...
            m_GameFrameworkScene = SceneManager.GetSceneAt(MDDGameEntry.GameFrameworkSceneId);
        ...
        private void Start()
        {
            ...
            {
                m_SceneManager.SetResourceManager(MDDGameFrameworkEntry.GetModule<IResourceManager>());
            }
        }
        ...
        private void OnLoadSceneSuccess(object sender, MDDGameFramework.LoadSceneSuccessEventArgs e)
        {
        ...
        private void OnLoadSceneFailure(object sender, MDDGameFramework.LoadSceneFailureEventArgs e)
        {
        ...
        private void OnLoadSceneUpdate(object sender, MDDGameFramework.LoadSceneUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, LoadSceneUpdateEventArgs.Create(e));
        }

        private void OnLoadSceneDependencyAsset(object sender, MDDGameFramework.LoadSceneDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(this, LoadSceneDependencyAssetEventArgs.Create(e));
        }

        private void OnUnloadSceneSuccess(object sender, MDDGameFramework.UnloadSceneSuccessEventArgs e)
        {
        ...
        private void OnUnloadSceneFailure(object sender, MDDGameFramework.UnloadSceneFailureEventArgs e)
        {
