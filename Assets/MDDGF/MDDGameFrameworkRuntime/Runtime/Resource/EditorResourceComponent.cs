...
namespace MDDGameFramework.Runtime
{
    ...
    public sealed class EditorResourceComponent : MonoBehaviour, IResourceManager
    {
        ...
        private MDDGameFrameworkLinkedList<LoadAssetInfo> m_LoadAssetInfos = null;
        private MDDGameFrameworkLinkedList<LoadSceneInfo> m_LoadSceneInfos = null;
        private MDDGameFrameworkLinkedList<UnloadSceneInfo> m_UnloadSceneInfos = null;
...
#pragma warning disable 0067, 0414
        ...
        /// 资源校验开始事件。
        /// </summary>
        public event EventHandler<MDDGameFramework.ResourceVerifyStartEventArgs> ResourceVerifyStart = null;

        /// <summary>
        /// 资源校验成功事件。
        /// </summary>
        public event EventHandler<MDDGameFramework.ResourceVerifySuccessEventArgs> ResourceVerifySuccess = null;

        /// <summary>
        /// 资源校验失败事件。
        /// </summary>
        public event EventHandler<MDDGameFramework.ResourceVerifyFailureEventArgs> ResourceVerifyFailure = null;

        /// <summary>
        /// 资源应用开始事件。
        /// </summary>
        public event EventHandler<MDDGameFramework.ResourceApplyStartEventArgs> ResourceApplyStart = null;

        /// <summary>
        /// 资源应用成功事件。
        /// </summary>
        public event EventHandler<MDDGameFramework.ResourceApplySuccessEventArgs> ResourceApplySuccess = null;

        /// <summary>
        /// 资源应用失败事件。
        /// </summary>
        public event EventHandler<MDDGameFramework.ResourceApplyFailureEventArgs> ResourceApplyFailure = null;

        /// <summary>
        /// 资源更新开始事件。
        /// </summary>
        public event EventHandler<MDDGameFramework.ResourceUpdateStartEventArgs> ResourceUpdateStart = null;

        /// <summary>
        /// 资源更新改变事件。
        /// </summary>
        public event EventHandler<MDDGameFramework.ResourceUpdateChangedEventArgs> ResourceUpdateChanged = null;

        /// <summary>
        /// 资源更新成功事件。
        /// </summary>
        public event EventHandler<MDDGameFramework.ResourceUpdateSuccessEventArgs> ResourceUpdateSuccess = null;

        /// <summary>
        /// 资源更新失败事件。
        /// </summary>
        public event EventHandler<MDDGameFramework.ResourceUpdateFailureEventArgs> ResourceUpdateFailure = null;

        /// <summary>
        /// 资源更新全部完成事件。
        /// </summary>
        public event EventHandler<MDDGameFramework.ResourceUpdateAllCompleteEventArgs> ResourceUpdateAllComplete = null;
...
#pragma warning restore 0067, 0414
        ...
        private void Awake()
        {
            ...
            m_LoadAssetInfos = new MDDGameFrameworkLinkedList<LoadAssetInfo>();
            m_LoadSceneInfos = new MDDGameFrameworkLinkedList<LoadSceneInfo>();
            m_UnloadSceneInfos = new MDDGameFrameworkLinkedList<UnloadSceneInfo>();
