...
namespace MDDGameFramework.Runtime
{
    ...
    public sealed class ResourceComponent : MDDGameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_ResourceHelperTypeName = "MDDGameFramework.Runtime.DefaultResourceHelper";

        [SerializeField]
        private ResourceHelperBase m_CustomResourceHelper = null;

        [SerializeField]
        private string m_LoadResourceAgentHelperTypeName = "MDDGameFramework.Runtime.DefaultLoadResourceAgentHelper";
        ...
        private void Start()
        {
            MDDBaseComponent baseComponent = MDDGameEntry.GetComponent<MDDBaseComponent>();
            ...
            m_EventComponent = MDDGameEntry.GetComponent<EventComponent>();
            ...
            m_ResourceManager = m_EditorResourceMode ? baseComponent.EditorResourceHelper : MDDGameFrameworkEntry.GetModule<IResourceManager>();
            ...
            m_ResourceManager.SetObjectPoolManager(MDDGameFrameworkEntry.GetModule<IObjectPoolManager>());
            m_ResourceManager.SetFileSystemManager(MDDGameFrameworkEntry.GetModule<IFileSystemManager>());
            m_ResourceManager.SetDownloadManager(MDDGameFrameworkEntry.GetModule<IDownloadManager>());
        ...
        private void OnResourceVerifyStart(object sender, MDDGameFramework.ResourceVerifyStartEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceVerifyStartEventArgs.Create(e));
        }

        private void OnResourceVerifySuccess(object sender, MDDGameFramework.ResourceVerifySuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceVerifySuccessEventArgs.Create(e));
        }

        private void OnResourceVerifyFailure(object sender, MDDGameFramework.ResourceVerifyFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceVerifyFailureEventArgs.Create(e));
        }

        private void OnResourceApplyStart(object sender, MDDGameFramework.ResourceApplyStartEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceApplyStartEventArgs.Create(e));
        }

        private void OnResourceApplySuccess(object sender, MDDGameFramework.ResourceApplySuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceApplySuccessEventArgs.Create(e));
        }

        private void OnResourceApplyFailure(object sender, MDDGameFramework.ResourceApplyFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceApplyFailureEventArgs.Create(e));
        }

        private void OnResourceUpdateStart(object sender, MDDGameFramework.ResourceUpdateStartEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateStartEventArgs.Create(e));
        }

        private void OnResourceUpdateChanged(object sender, MDDGameFramework.ResourceUpdateChangedEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateChangedEventArgs.Create(e));
        }

        private void OnResourceUpdateSuccess(object sender, MDDGameFramework.ResourceUpdateSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateSuccessEventArgs.Create(e));
        }

        private void OnResourceUpdateFailure(object sender, MDDGameFramework.ResourceUpdateFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateFailureEventArgs.Create(e));
        }

        private void OnResourceUpdateAllComplete(object sender, MDDGameFramework.ResourceUpdateAllCompleteEventArgs e)
        {
