...
namespace MDDGameFramework.Runtime
{
    ...
    public sealed partial class EntityComponent : MDDGameFrameworkComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_EntityManager = MDDGameFrameworkEntry.GetModule<IEntityManager>();
        ...
        private void OnShowEntitySuccess(object sender, MDDGameFramework.ShowEntitySuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ShowEntitySuccessEventArgs.Create(e));
        }

        private void OnShowEntityFailure(object sender, MDDGameFramework.ShowEntityFailureEventArgs e)
        {
        ...
        private void OnShowEntityUpdate(object sender, MDDGameFramework.ShowEntityUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, ShowEntityUpdateEventArgs.Create(e));
        }

        private void OnShowEntityDependencyAsset(object sender, MDDGameFramework.ShowEntityDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(this, ShowEntityDependencyAssetEventArgs.Create(e));
        }

        private void OnHideEntityComplete(object sender, MDDGameFramework.HideEntityCompleteEventArgs e)
        {
