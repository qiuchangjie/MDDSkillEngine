...
namespace MDDGameFramework.Runtime
{
    ...
    public sealed partial class UIComponent : MDDGameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_UIFormHelperTypeName = "MDDGameFramework.Runtime.DefaultUIFormHelper";
        ...
        protected override void Awake()
        {
            ...
            m_UIManager = MDDGameFrameworkEntry.GetModule<IUIManager>();
            if (m_UIManager == null)
            {
        ...
        private void OnOpenUIFormSuccess(object sender, MDDGameFramework.OpenUIFormSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, OpenUIFormSuccessEventArgs.Create(e));
        }

        private void OnOpenUIFormFailure(object sender, MDDGameFramework.OpenUIFormFailureEventArgs e)
        {
        ...
        private void OnOpenUIFormUpdate(object sender, MDDGameFramework.OpenUIFormUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, OpenUIFormUpdateEventArgs.Create(e));
        }

        private void OnOpenUIFormDependencyAsset(object sender, MDDGameFramework.OpenUIFormDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(this, OpenUIFormDependencyAssetEventArgs.Create(e));
        }

        private void OnCloseUIFormComplete(object sender, MDDGameFramework.CloseUIFormCompleteEventArgs e)
        {
