...
{
    internal sealed class FsmManager :MDDGameFrameworkModule,IFsmManager
    {
        ...
        public bool HasFsm(Type ownerType)
        {
            if (ownerType == null)
            {
                throw new MDDGameFrameworkException("Owner type is invalid.");
            }
        ...
        public IFsm<T> CreateFsm<T>(string name, T owner, params FsmState<T>[] states) where T : class
        {
            ...
            if (HasFsm<T>(name))
            {
                throw new MDDGameFrameworkException(Utility.Text.Format("Already exist FSM '{0}'.", typeNamePair));
            }
