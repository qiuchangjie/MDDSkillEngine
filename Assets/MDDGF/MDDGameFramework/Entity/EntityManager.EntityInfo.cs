    ...
    internal sealed partial class EntityManager : MDDGameFrameworkModule, IEntityManager
    {
        ...
        private sealed class EntityInfo : IReference
        {
            ...
            public void AddChildEntity(IEntity childEntity)
            {
                ...
                {
                    throw new MDDGameFrameworkException("Can not add child entity which is already exist.");
                }
            ...
            public void RemoveChildEntity(IEntity childEntity)
            {
                ...
                {
                    throw new MDDGameFrameworkException("Can not remove child entity which is not exist.");
                }
            }
        }
    }
