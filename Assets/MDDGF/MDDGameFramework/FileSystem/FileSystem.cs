...
namespace MDDGameFramework
{
    ...
    internal sealed partial class FileSystem : IFileSystem
    {
        ...
        private readonly MDDGameFrameworkMultiDictionary<int, int> m_FreeBlockIndexes;
        ...
        private FileSystem(string fullPath, FileSystemAccess access, FileSystemStream stream)
        {
            ...
            {
                throw new MDDGameFrameworkException("Full path is invalid.");
            }

            if (access == FileSystemAccess.Unspecified)
            {
                throw new MDDGameFrameworkException("Access is invalid.");
            }

            if (stream == null)
            {
                throw new MDDGameFrameworkException("Stream is invalid.");
            }
            ...
            m_FreeBlockIndexes = new MDDGameFrameworkMultiDictionary<int, int>();
        ...
        public static FileSystem Create(string fullPath, FileSystemAccess access, FileSystemStream stream, int maxFileCount, int maxBlockCount)
        {
            if (maxFileCount <= 0)
            {
                throw new MDDGameFrameworkException("Max file count is invalid.");
            }

            if (maxBlockCount <= 0)
            {
                throw new MDDGameFrameworkException("Max block count is invalid.");
            }

            if (maxFileCount > maxBlockCount)
            {
                throw new MDDGameFrameworkException("Max file count can not larger than max block count.");
            }
        ...
        public static FileSystem Load(string fullPath, FileSystemAccess access, FileSystemStream stream)
        {
            ...
            {
                throw new MDDGameFrameworkException(Utility.Text.Format("File system '{0}' is invalid.", fullPath));
            }
        ...
        public byte[] ReadFile(string name)
        {
            ...
            {
                throw new MDDGameFrameworkException("File system is not readable.");
            }
        ...
        public int ReadFile(string name, byte[] buffer, int startIndex, int length)
        {
            ...
            {
                throw new MDDGameFrameworkException("Start index or length is invalid.");
            }
        ...
        public int ReadFile(string name, Stream stream)
        {
            ...
            if (!stream.CanWrite)
            {
                throw new MDDGameFrameworkException("Stream is not writable.");
            }
        ...
        public byte[] ReadFileSegment(string name, int offset, int length)
        {
            ...
            if (offset < 0)
            {
                throw new MDDGameFrameworkException("Index is invalid.");
            }

            if (length < 0)
            {
                throw new MDDGameFrameworkException("Length is invalid.");
            }
        ...
        public bool WriteFile(string name, byte[] buffer, int startIndex, int length)
        {
            ...
            {
                throw new MDDGameFrameworkException("File system is not writable.");
            }
            ...
            {
                throw new MDDGameFrameworkException(Utility.Text.Format("Name '{0}' is too long.", name));
            }
        ...
        public bool WriteFile(string name, Stream stream)
        {
            ...
            if (!stream.CanRead)
            {
                throw new MDDGameFrameworkException("Stream is not readable.");
            }
        ...
        public bool WriteFile(string name, string filePath)
        {
            ...
            {
                throw new MDDGameFrameworkException("File path is invalid");
            }
        ...
        public bool RenameFile(string oldName, string newName)
        {
            ...
            {
                throw new MDDGameFrameworkException("Old name is invalid.");
            }

            if (string.IsNullOrEmpty(newName))
            {
                throw new MDDGameFrameworkException("New name is invalid.");
            }

            if (newName.Length > byte.MaxValue)
            {
                throw new MDDGameFrameworkException(Utility.Text.Format("New name '{0}' is too long.", newName));
            }
        ...
        private bool TryCombineFreeBlocks(int freeBlockIndex)
        {
            ...
            foreach (KeyValuePair<int, MDDGameFrameworkLinkedListRange<int>> blockIndexes in m_FreeBlockIndexes)
            {
        ...
        {
            MDDGameFrameworkLinkedListRange<int> lengthRange = default(MDDGameFrameworkLinkedListRange<int>);
        ...
        private int AllocBlock(int length)
        {
            ...
            int lengthFound = -1;
            MDDGameFrameworkLinkedListRange<int> lengthRange = default(MDDGameFrameworkLinkedListRange<int>);
            foreach (KeyValuePair<int, MDDGameFrameworkLinkedListRange<int>> i in m_FreeBlockIndexes)
            {
                if (i.Key < length)
                {
                    continue;
