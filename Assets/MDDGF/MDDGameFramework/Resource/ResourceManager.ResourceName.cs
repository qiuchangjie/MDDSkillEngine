    ...
    internal sealed partial class ResourceManager : MDDGameFrameworkModule, IResourceManager
    {
        ...
        private struct ResourceName : IComparable, IComparable<ResourceName>, IEquatable<ResourceName>
        {
            ...
            public ResourceName(string name, string variant, string extension)
            {
                ...
                {
                    throw new MDDGameFrameworkException("Resource name is invalid.");
                }

                if (string.IsNullOrEmpty(extension))
                {
                    throw new MDDGameFrameworkException("Resource extension is invalid.");
                }
            ...
            public int CompareTo(object value)
            {
                ...
                {
                    throw new MDDGameFrameworkException("Type of value is invalid.");
                }
