...
namespace MDDGameFramework
{
    internal sealed partial class ResourceManager : MDDGameFrameworkModule, IResourceManager
    {
        ...
        private sealed partial class ResourceUpdater
        {
            ...
            public MDDGameFrameworkAction<string, int, long> ResourceApplyStart;
            public MDDGameFrameworkAction<ResourceName, string, string, int, int> ResourceApplySuccess;
            public MDDGameFrameworkAction<ResourceName, string, string> ResourceApplyFailure;
            public MDDGameFrameworkAction<string, bool> ResourceApplyComplete;
            public MDDGameFrameworkAction<ResourceName, string, string, int, int, int> ResourceUpdateStart;
            public MDDGameFrameworkAction<ResourceName, string, string, int, int> ResourceUpdateChanged;
            public MDDGameFrameworkAction<ResourceName, string, string, int, int> ResourceUpdateSuccess;
            public MDDGameFrameworkAction<ResourceName, string, int, int, string> ResourceUpdateFailure;
            public MDDGameFrameworkAction<ResourceGroup, bool> ResourceUpdateComplete;
            public MDDGameFrameworkAction ResourceUpdateAllComplete;
            ...
            public void ApplyResources(string resourcePackPath)
            {
                ...
                {
                    throw new MDDGameFrameworkException("You must check resources complete first.");
                }

                if (m_ApplyingResourcePackStream != null)
                {
                    throw new MDDGameFrameworkException(Utility.Text.Format("There is already a resource pack '{0}' being applied.", m_ApplyingResourcePackPath));
                }

                if (m_UpdatingResourceGroup != null)
                {
                    throw new MDDGameFrameworkException(Utility.Text.Format("There is already a resource group '{0}' being updated.", m_UpdatingResourceGroup.Name));
                }

                if (m_UpdateWaitingInfoWhilePlaying.Count > 0)
                {
                    throw new MDDGameFrameworkException("There are already some resources being updated while playing.");
                }
                ...
                try
                {
                    ...
                    {
                        throw new MDDGameFrameworkException("Deserialize resource pack version list failure.");
                    }

                    if (versionList.Offset + versionList.Length != length)
                    {
                        throw new MDDGameFrameworkException("Resource pack length is invalid.");
                    }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new MDDGameFrameworkException(Utility.Text.Format("Apply resources '{0}' with exception '{1}'.", resourcePackPath, exception), exception);
                }
            }
            ...
            public void UpdateResources(ResourceGroup resourceGroup)
            {
                if (m_DownloadManager == null)
                {
                    throw new MDDGameFrameworkException("You must set download manager first.");
                }
            ...
            public void StopUpdateResources()
            {
                ...
                if (m_UpdatingResourceGroup == null)
                {
                    throw new MDDGameFrameworkException("There is no resource group being updated.");
                }
            ...
            private void GenerateReadWriteVersionList()
            {
                ...
                try
                {
                    ...
                    {
                        throw new MDDGameFrameworkException("Serialize read-write version list failure.");
                    }
                ...
                catch (Exception exception)
                {
                    ...
                    throw new MDDGameFrameworkException(Utility.Text.Format("Generate read-write version list exception '{0}'.", exception), exception);
                }
            ...
            private void OnDownloadStart(object sender, DownloadStartEventArgs e)
            {
                ...
                {
                    throw new MDDGameFrameworkException(Utility.Text.Format("File '{0}' is too large.", e.DownloadPath));
                }
