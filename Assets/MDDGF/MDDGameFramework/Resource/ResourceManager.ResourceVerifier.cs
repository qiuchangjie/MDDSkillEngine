...
namespace MDDGameFramework
{
    internal sealed partial class ResourceManager : MDDGameFrameworkModule, IResourceManager
    {
        ...
        private sealed partial class ResourceVerifier
        {
            ...
            public MDDGameFrameworkAction<int, long> ResourceVerifyStart;
            public MDDGameFrameworkAction<ResourceName, int> ResourceVerifySuccess;
            public MDDGameFrameworkAction<ResourceName> ResourceVerifyFailure;
            public MDDGameFrameworkAction<bool> ResourceVerifyComplete;
            ...
            public void VerifyResources(int verifyResourceLengthPerFrame)
            {
                ...
                {
                    throw new MDDGameFrameworkException("Verify resource count per frame is invalid.");
                }
