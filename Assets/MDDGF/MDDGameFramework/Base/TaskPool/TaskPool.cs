...
namespace MDDGameFramework
{
    ...
    internal sealed class TaskPool<T> where T : TaskBase
    {
        ...
        private readonly MDDGameFrameworkLinkedList<ITaskAgent<T>> m_WorkingAgents;
        private readonly MDDGameFrameworkLinkedList<T> m_WaitingTasks;
        ...
        public TaskPool()
        {
            ...
            m_WorkingAgents = new MDDGameFrameworkLinkedList<ITaskAgent<T>>();
            m_WaitingTasks = new MDDGameFrameworkLinkedList<T>();
            m_Paused = false;
        }
        ...
        public void AddAgent(ITaskAgent<T> agent)
        {
            if (agent == null)
            {
                throw new MDDGameFrameworkException("Task agent is invalid.");
            }
