...
// Homepage: https://MDDGameFramework.cn/
// Feedback: mailto:ellan@MDDGameFramework.cn
//------------------------------------------------------------
...
namespace MDDGameFramework
{
    ...
    /// 读取数据时加载依赖资源事件。
    /// </summary>
    public sealed class ReadDataDependencyAssetEventArgs : MDDGameFrameworkEventArgs
    {
        /// <summary>
