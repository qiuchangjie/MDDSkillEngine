...
namespace MDDGameFramework
{
    internal sealed partial class DownloadManager : MDDGameFrameworkModule, IDownloadManager
    {
        ...
        {
            private readonly MDDGameFrameworkLinkedList<DownloadCounterNode> m_DownloadCounterNodes;
            ...
            public DownloadCounter(float updateInterval, float recordInterval)
            {
                ...
                {
                    throw new MDDGameFrameworkException("Update interval is invalid.");
                }

                if (recordInterval <= 0f)
                {
                    throw new MDDGameFrameworkException("Record interval is invalid.");
                }

                m_DownloadCounterNodes = new MDDGameFrameworkLinkedList<DownloadCounterNode>();
