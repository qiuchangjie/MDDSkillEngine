...
{
    internal sealed partial class DownloadManager : MDDGameFrameworkModule, IDownloadManager
    {
        /// <summary>
        /// 下载代理。
        /// </summary>
        private sealed class DownloadAgent : ITaskAgent<DownloadTask>, IDisposable
        {
            ...
            public MDDGameFrameworkAction<DownloadAgent> DownloadAgentStart;
            public MDDGameFrameworkAction<DownloadAgent, int> DownloadAgentUpdate;
            public MDDGameFrameworkAction<DownloadAgent, long> DownloadAgentSuccess;
            public MDDGameFrameworkAction<DownloadAgent, string> DownloadAgentFailure;
            ...
            public DownloadAgent(IDownloadAgentHelper downloadAgentHelper)
            {
                ...
                {
                    throw new MDDGameFrameworkException("Download agent helper is invalid.");
                }
            ...
            private void OnDownloadAgentHelperComplete(object sender, DownloadAgentHelperCompleteEventArgs e)
            {
                ...
                {
                    throw new MDDGameFrameworkException("Internal download error.");
                }
