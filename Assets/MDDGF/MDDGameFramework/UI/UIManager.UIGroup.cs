...
namespace MDDGameFramework
{
    internal sealed partial class UIManager : MDDGameFrameworkModule, IUIManager
    {
        ...
        private sealed partial class UIGroup : IUIGroup
        {
            ...
            private readonly MDDGameFrameworkLinkedList<UIFormInfo> m_UIFormInfos;
            ...
            public UIGroup(string name, int depth, IUIGroupHelper uiGroupHelper)
            {
                ...
                m_UIFormInfos = new MDDGameFrameworkLinkedList<UIFormInfo>();
                m_CachedNode = null;
                Depth = depth;
            }
            ...
            public void RemoveUIForm(IUIForm uiForm)
            {
                ...
                if (uiFormInfo == null)
                {
                    throw new MDDGameFrameworkException(Utility.Text.Format("Can not find UI form info for serial id '{0}', UI form asset name is '{1}'.", uiForm.SerialId.ToString(), uiForm.UIFormAssetName));
                }
                ...
                {
                    throw new MDDGameFrameworkException(Utility.Text.Format("UI group '{0}' not exists specified UI form '[{1}]{2}'.", m_Name, uiForm.SerialId.ToString(), uiForm.UIFormAssetName));
                }
            ...
            public void RefocusUIForm(IUIForm uiForm, object userData)
            {
                ...
                if (uiFormInfo == null)
                {
                    throw new MDDGameFrameworkException("Can not find UI form info.");
                }
