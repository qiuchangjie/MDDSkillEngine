...
namespace MDDGameFramework
{
    ...
    /// 界面管理器。
    /// </summary>
    internal sealed partial class UIManager : MDDGameFrameworkModule, IUIManager
    {
        ...
        public void SetUIFormHelper(IUIFormHelper uiFormHelper)
        {
            ...
            {
                throw new MDDGameFrameworkException("UI form helper is invalid.");
            }
        ...
        public bool HasUIGroup(string uiGroupName)
        {
            ...
            {
                throw new MDDGameFrameworkException("UI group name is invalid.");
            }
        ...
        public bool AddUIGroup(string uiGroupName, int uiGroupDepth, IUIGroupHelper uiGroupHelper)
        {
            ...
            {
                throw new MDDGameFrameworkException("UI group helper is invalid.");
            }
        ...
        public bool HasUIForm(string uiFormAssetName)
        {
            ...
            {
                throw new MDDGameFrameworkException("UI form asset name is invalid.");
            }
        ...
        public int OpenUIForm(string uiFormAssetName, string uiGroupName, int priority, bool pauseCoveredUIForm, object userData)
        {
            ...
            {
                throw new MDDGameFrameworkException("You must set UI form helper first.");
            }
            ...
            if (uiGroup == null)
            {
                throw new MDDGameFrameworkException(Utility.Text.Format("UI group '{0}' is not exist.", uiGroupName));
            }
        ...
        public void CloseUIForm(int serialId, object userData)
        {
            ...
            if (uiForm == null)
            {
                throw new MDDGameFrameworkException(Utility.Text.Format("Can not find UI form '{0}'.", serialId.ToString()));
            }
        ...
        public void CloseUIForm(IUIForm uiForm, object userData)
        {
            if (uiForm == null)
            {
                throw new MDDGameFrameworkException("UI form is invalid.");
            }

            UIGroup uiGroup = (UIGroup)uiForm.UIGroup;
            if (uiGroup == null)
            {
                throw new MDDGameFrameworkException("UI group is invalid.");
            }
        ...
        public void SetUIFormInstanceLocked(object uiFormInstance, bool locked)
        {
            ...
            {
                throw new MDDGameFrameworkException("UI form instance is invalid.");
            }
        ...
        private void InternalOpenUIForm(int serialId, string uiFormAssetName, UIGroup uiGroup, object uiFormInstance, bool pauseCoveredUIForm, bool isNewInstance, float duration, object userData)
        {
            try
            {
                ...
                if (uiForm == null)
                {
                    throw new MDDGameFrameworkException("Can not create UI form in UI form helper.");
                }
        ...
        private void LoadAssetSuccessCallback(string uiFormAssetName, object uiFormAsset, float duration, object userData)
        {
            ...
            {
                throw new MDDGameFrameworkException("Open UI form info is invalid.");
            }
        ...
        private void LoadAssetFailureCallback(string uiFormAssetName, string a, string errorMessage, object userData)
        {
            OpenUIFormInfo openUIFormInfo = (OpenUIFormInfo)userData;
            if (openUIFormInfo == null)
            {
            ...
            m_UIFormsBeingLoaded.Remove(openUIFormInfo.SerialId);
            string appendErrorMessage = Utility.Text.Format("Load UI form failure, asset name '{0}', status '{1}', error message '{2}'.", uiFormAssetName, a, errorMessage);
            if (m_OpenUIFormFailureEventHandler != null)
            {
