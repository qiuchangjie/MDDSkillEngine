...
namespace MDDSkillEngine
{
    ...
    public class DRPlayer : DataRowBase
    {
        ...
        public int GetWeaponId(int id)
        {
            ...
            throw new MDDGameFrameworkException(Utility.Text.Format("GetWeaponId with invalid id '{0}'.", id.ToString()));
        }
        ...
        public int GetWeaponIdAt(int index)
        {
            ...
            {
                throw new MDDGameFrameworkException(Utility.Text.Format("GetWeaponIdAt with invalid index '{0}'.", index.ToString()));
            }
        ...
        public int GetArmorId(int id)
        {
            ...
            throw new MDDGameFrameworkException(Utility.Text.Format("GetArmorId with invalid id '{0}'.", id.ToString()));
        }
        ...
        public int GetArmorIdAt(int index)
        {
            ...
            {
                throw new MDDGameFrameworkException(Utility.Text.Format("GetArmorIdAt with invalid index '{0}'.", index.ToString()));
            }
