...
{
    public class HPBarComponent : MDDGameFrameworkComponent
    {
        [SerializeField]
        ...
        private void Start()
        {
            ...
            m_HPBarItemObjectPool = GameEnter.ObjectPool.CreateSingleSpawnObjectPool<HPBarItemObject>("HPBarItem", m_InstancePoolCapacity);
